...
urlpatterns = [
    ...
    path('file/', login_required(views.FilesView.as_view(), '', '/'), name='files'),
    ...
    path('medical-act/', login_required(views.MedicalActsView.as_view(), '', '/'), name='medical_acts'),
    ...
    path('medical-compensation/', login_required(views.MedicalCompensationView.as_view(), '', '/'), name='medical_compensations'),
