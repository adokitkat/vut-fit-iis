...
class CustomUserCreationForm(UserCreationForm):
  ...
  tel_number = forms.CharField(required=False, max_length=50, label='Phone number', widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': '00421 900 123 456'}),)
